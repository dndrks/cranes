...
function _params.init()
  ...
  --
  for i = 1,TRACKS do
    params:add_control("pan_"..i,"pan voice "..i,controlspec.new(-1,1,'lin',0.01,0,''))
  ...
  for i = 1,TRACKS do
    ...
    params:add_control("post_filter_lp_"..i,i.." lopass",controlspec.new(0,1,'lin',0,0,''))
    ...
    params:add_control("post_filter_dry_"..i,i.." dry",controlspec.new(0,1,'lin',0.01,1,''))
  ...
  params.action_write = function(filename,name)
    ...
    softcut.buffer_write_mono(AUDIO_DIR..name.."-clip_1.wav",0,60,1)
    softcut.buffer_write_mono(AUDIO_DIR..name.."-clip_2.wav",0,60,2)
  end
